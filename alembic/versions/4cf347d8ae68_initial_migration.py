...
def upgrade() -> None:
    ...
    sa.Column('storage_status', sa.Enum('NOT_STORED', 'STORING', 'STORED', 'STORAGE_FAILED', 'DELETING', name='storagestatus'), nullable=False),
    sa.Column('storage_error', sa.String(length=1024), nullable=True),
    sa.Column('cad_type', sa.Enum('ALTIUM', 'KICAD', name='cadtype'), nullable=False),
    ...
    op.create_table('capacitor_ceramic',
    sa.Column('id', sa.Integer(), nullable=False),
